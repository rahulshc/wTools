...
Рутина `pre` призначена для підготовки [мапи опцій](../concept/MapOptions.md), котра передається в рутину `body`. В рутині `body` виконується обробка даних, вона приймає мапу опцій і має опції за замовчуванням.
