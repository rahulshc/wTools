...
> `Тест сюіт` (тест комлект,тестовий набір) - це набір тест рутин, та тестових данних, необхідних для тестування об'єкти тестування. Кожен тест сюіт має власний файл. Кожен тест сюіт реалізований у вигляді класа. Один тест сюіт може успадковувати.
