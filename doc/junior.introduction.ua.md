...
|:----------|:------------------------------------------------------------|:-----------------------------------------------------|
|[1](#1)    | Через npm                                                   | `npm test`                                           |
|[2.1](#2.1)| Через тестер, вказуючи теку                                 | `wtest staging`                                      |
|[2.2](#2.2)| Через тестер, вказуючи файл тест сюіта                      | `wtest staging/dwtools/abase/layer1.test/Map.test.s` |
|[3](#3)    | Безпосередньо через файл тест сюіта                         | `node staging/dwtools/abase/layer1.test/Map.test.s`  |

Всі команди припускають, що проект є поточною текою.
...
Экран терміналу вищовказаних команд в операційній системі Linux буде виглядати наступним чином:
...
> `Тест сюіт` (тест комлект,тестовий набір) - це набір тест рутин, та тестових данних, необхідних для тестування об'єкти тестування. Найбільша структурна одиниця тестування. Кожен тест сюіт має власний файл. Кожен тест сюіт реалізований у вигляді класа. Один тест сюіт може успадковувати інший.
