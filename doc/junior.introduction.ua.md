...
Результат команди 2.2 см.визначення тест сюіту <a name="testing-structure-units"/>

![Результат команди 2.2](./reference/img/2.2.png)

<a name="3"/>

Результат команди 3 см.визначення тест сюіту <a name="testing-structure-units"/>
