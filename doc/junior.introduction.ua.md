...
![Результат команди 2.1](./img/2.1.png) Це - альтернативний спосіб запуску тестування. Команда для запуска `wtest proto`. Спосіб [1](#1) та [2.1](#2.1) виконує усі наявні тест сюіти
...
Тест рутина `mapsAreIdentical` має таку реалізацію:
