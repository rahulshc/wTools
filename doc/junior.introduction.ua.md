...
приоритету або одному типу тестування. Кожний тест сюіт
містить більш ніж один тест кейс та виконується загалом усією "пачкою" в процесі тестування.

> Тест кейси поєднують в тест сюіти для більшого зручності при проходженні тестів, проходячи їх послідовно від модуля до модуля, а не сумбурно, залишив не перевіренною більшу частину модуля або загальної функціональності.  
