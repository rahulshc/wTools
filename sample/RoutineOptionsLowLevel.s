...
var got = _.routineOptions( routine, options, defaults );
console.log( got );
/* log : { a : 1, b : 1 } */
...
var got = _.assertRoutineOptions( routine, options, defaults );
console.log( got );
/* log : { a : 1, b : null } */
...
routine.defaults = { a : null, b : 1 };
var options = { a : 1, b : null };
var got = _.assertRoutineOptions( routine, options );
console.log( got );
/* log : { a : 1, b : null } */
