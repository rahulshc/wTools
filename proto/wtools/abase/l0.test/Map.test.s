...
function typingBasic( test ) /* qqq : extend with construbile* checks */
{
  ...
  test.identical( _.auxiliary.isPolluted( src ), false );
  test.identical( _.mapIsEmpty( src ), true );
  test.identical( _.auxiliary.isEmpty( src ), true );
  test.identical( _.mapIsPopulated( src ), false );
  test.identical( _.auxiliary.isPopulated( src ), false );
  ...
  test.identical( _.auxiliary.isEmpty( src ), false );
  test.identical( _.mapIsPopulated( src ), true );
  test.identical( _.auxiliary.isPopulated( src ), true );
  ...
  test.identical( _.auxiliary.isPolluted( src ), true );
  test.identical( _.mapIsEmpty( src ), true );
  test.identical( _.auxiliary.isEmpty( src ), true );
  test.identical( _.mapIsPopulated( src ), false );
  test.identical( _.auxiliary.isPopulated( src ), false );
