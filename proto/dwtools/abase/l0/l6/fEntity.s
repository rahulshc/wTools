...
* @param { Function } onEvaluate - It's a callback. If the routine has two parameters, it is used as an equalizer, and if it has only one, then routine is used as the evaluator.
