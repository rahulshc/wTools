...
function arrayFlattenOnceSets( test )
{
  ...
  var dst = [ 1, undefined, [ 2 ], { a : 0 } ];
  var src = new Set( [ dst, [ dst, dst ] ] );
  var got = _.arrayFlattenOnce( dst, src, 1, ( ins ) => ins );
...
function arrayFlattenedOnceSets( test )
{
  ...
  var dst = [ 1, undefined, [ 2 ], { a : 0 } ];
  var src = new Set( [ dst, [ dst, dst ] ] );
  var got = _.arrayFlattenedOnce( dst, src, 1, ( ins ) => ins );
  test.identical( dst, [ 1, undefined, [ 2 ], { a : 0 }, 1, 2 ] );
  test.identical( got, 2 );
...
function arrayFlattenDefined( test )
{
  ...
  // test.case = 'more then one src';
  // var dst = [ 1, 1, 3, 3, [ 5, 5 ] ];
  // var got = _.arrayFlattenDefined( dst, 5, [ 2, 3 ], 'str' );
  // var expected = [ 1, 1, 3, 3, [ 5, 5 ], 5, 2, 3, 'str' ];
  // test.identical( dst, expected );
  // test.identical( got, 4 );
...
function arrayFlattenedDefined( test )
{
  ...
  // test.case = 'more then one src';
  // var dst = [ 1, 1, 3, 3, [ 5, 5 ] ];
  // var got = _.arrayFlattenedDefined( dst, 5, [ 2, 3 ], 'str' );
  // var expected = [ 1, 1, 3, 3, [ 5, 5 ], 5, 2, 3, 'str' ];
  // test.identical( dst, expected );
  // test.identical( got, 4 );
